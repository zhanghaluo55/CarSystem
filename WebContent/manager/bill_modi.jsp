...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
       ...
       <%
       		...
       		Order order=DaoFactory.getOrderDao_magInstance().findById(oid);
 	      
       %>
	            <form action="DoupdateCar" method="" class="main_form">
            	
            	<div class="text_info clearfix"><span>订单ID：</span></div>
                <div class="input_info">
                    <input type="text" class="width200" name="oid" value="<%=oid %>"/>
                ...
                <div class="input_info">
                    <input type="text" class="width200" name="order.out_trade_no" value="<%=order.getOut_trade_no() %>"/>
                    <span class="required">*</span>
                </div> 
            	
                <div class="text_info clearfix"><span>价格：</span></div>
                <div class="input_info">
                    <input type="text" class="width200" name="order.price" value="<%=order.getPrice() %>"/>
                    <span class="required">*</span>
                </div>   
                
                <div class="text_info clearfix"><span>数量：</span></div>
                <div class="input_info">
                    <input type="text" class="width200" name="order.qunatity" value="<%=order.getQunatity() %>"/>
                    <span class="required">*</span>
                </div>
                
                <div class="text_info clearfix"><span>日期：</span></div>
                <div class="input_info">
                    <input type="date" class="width200" name="order.odate" value="<%=order.getOdate() %>"/>
                    <span class="required">*</span>
                </div>
                
                <div class="text_info clearfix"><span>是否支付：</span></div>
                <div class="input_info">
                    <input type="text" class="width200" name="order.flag" value="<%=order.getFlag() %>"/>
                    <span class="required">*</span>
                </div>
                
                <div class="text_info clearfix"><span>购车用户ID：</span></div>
                <div class="input_info">
                    <input type="text" class="width200" name="uoid" value="<%=order.getUser().getUid() %>"/>
                    <span class="required">*</span>
                </div>
                
                <div class="text_info clearfix"><span>所购车ID：</span></div>
                <div class="input_info">
                    <input type="text" class="width200" name="coid" value="<%=order.getCar().getCid() %>"/>
                    <span class="required">*</span>
                </div>                                           
