...
<!--成功-->
  ...
  <div class="page clearfix">
   <div class="success_style">
     <div class="success_img"><img src="images/success.png" /></div>
     <h2>付款成功，请前往个人中心确认订单。</h2>
     <h3>网站默认<b id="sec" class="color2">6</b>秒后返回首页</h3>
     <div class="success_btn_style"><a href="index.jsp" class="btn btn_red radius">网站首页</a><a href="user_intro.jsp" class="btn btn_red radius">用户中心</a></div>
   </div>
 </div>
</div>
<!--优势-->
