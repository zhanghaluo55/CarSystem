...
<!-- 		    <li><a href="询价订单.html">询价订单</a></li>
            ...
            <li><a href="orderAction!pagelist.action?page=1">新车订单</a></li>
		   </ul>
		</div>
       </li> 
...
<div class="header relative clearfix">
  ...
  <div class="page clearfix">
    ...
    <div class="menu_style">
     ...
     <div class="user_portrait">
      ...
      <div class="user_name">
       <p><span class="name">${user1.uname}</span><a href="#">[修改密码]</a></p>
 ...
 <!--       <dl class="accountSideOption1">
      <dt class="transaction_manage"><a href="用户中心_询价订单.html">询价订单</a></dt>
      <dd></dd>
    </dl> 
    <dl class="accountSideOption1">
 ...
 <thead>
  <tr>
   <th width="450px">车辆信息</th>
   <th width="200px">价格</th>
   <th width="150px">定金</th>
 ...
 <s:if test="#session.user1.getUid()==user.getUid()">
 <tbody>
  <tr class="order_number">
   <td colspan="6"><span class="Numbering">订单号：</span>${out_trade_no} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="time">下单时间：<s:property value="odate"/> </span></td>
  </tr>
   <tr class="Inquiry_order_content">
   <td class="car_info">
    <a href="carAction!carIntro.action?car.cid=${car.cid}" class="car_img"><img src="carImage/${car.picturePath}1.jpg"  width="68" height="68"/></a>
    <span class="product_style"> <a href="carAction!carIntro.action?car.cid=${car.cid}" class="p_name">${car.getCname()}</a><p>颜色：蓝色</p></span>
   </td>
   <td class="bx_price">￥${price}万</td>
   <td class="bx_price">￥<fmt:formatNumber type="number" value="${price*0.01*10000}" pattern="0.00" maxFractionDigits="2" /></td>
   <td >${qunatity}</td>
   <td>${flag}</td>
   <td>
    <a href="carAction!carIntro.action?car.cid=${car.cid}" class="btn detailed_btn mb15">查看详细</a>
    <a href="orderAction!orderpay.action?oid=${oid}" class="btn Inquiry_btn mb15">立即支付</a>
    <a href="orderAction!orderReRep.action?oid=${oid}" class="btn btn_orange ">关闭交易</a>
   </td>
  </tr>
 </tbody>
  </s:if> 
  ...
  <!-- <tbody>
  <tr class="order_number">
   <td colspan="6"><span class="Numbering">订单号：</span>WE123456789098 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="time">下单时间：2017-2-12 11:12</span></td>
  </tr>
   <tr class="Inquiry_order_content">
   <td class="car_info">
    <a href="产品详细.html" class="car_img"><img src="images/products/6.jpg"  width="68" height="68"/></a>
    <span class="product_style"> <a href="产品详细.html" class="p_name">广汽传祺 传祺GS4 2017款 235T 自动两驱豪华智联版</a><p>颜色：蓝色</p></span>
   </td>
   <td class="bx_price">￥12.45万</td>
   <td class="bx_price">￥9999</td>
   <td >1</td>
   <td>已生效</td>
   <td>
    <a href="产品详细.html" class="btn detailed_btn mb15">查看详细</a>
    <a href="用户中心_取消订单.html" class="btn btn_orange ">取消订单</a>
   </td>
  </tr>
 </tbody>
  <tbody>
  <tr class="order_number">
   ...
   <td>
    <a href="产品详细.html" class="btn detailed_btn mb15">查看详细</a>
    <a href="产品详细.html#status2" class="btn Inquiry_btn">用户评论</a>
   </td>
  </tr>
 </tbody> -->
</table>
    ...
    <a href="orderAction!pagelist.action?page=1">首页</a>
     <a href="orderAction!pagelist.action?page=<s:property value="#request.session.pageBean.currentPage - 1"/>" class="pn-prev disabled">&lt;上一页</a>
	<c:forEach begin="1" end="${pageBean.totalPage}" step="1" var="i">
	<c:choose>	
		<c:when test="${pageBean.currentPage==i}">
			<a id="ye" href="orderAction!pagelist.action?page=${i}" class="on">${i}</a>		
		</c:when>
		<c:otherwise>
			<a id="ye" href="orderAction!pagelist.action?page=${i}">${i}</a>
		</c:otherwise>
	</c:choose>
	</c:forEach>
	 <a href="orderAction!pagelist.action?page=<s:property value="#request.session.pageBean.currentPage + 1"/>">下一页&gt;</a>
	 <a href="orderAction!pagelist.action?page=<s:property value="#request.session.pageBean.totalPage"/>">尾页</a>	
     </div>
    </div>
  </div>
  </div>    
