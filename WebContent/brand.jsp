...
<div class="page clearfix">
 <div class="all_Brand_list marginsx20 clearfix">
 <div class="left_Brand_list">
  <div class="Brand_title">汽车品牌展示 <span class="Brand_Quantity">共销售品牌：<b>14</b>个</span></div>
  <div class="Brandlogo_list">
   <dl class="mb15">
    <dt>国产车</dt>
    <dd class="marginsx20 clearfix">
     <a href="carAction!selectbyBrand.action?brand='比亚迪'" class="logo_name"> <img src="carImage/商标/比亚迪.jpg" width="70px" height="60px" /><h5>比亚迪汽车</h5></a>
     <a href="carAction!selectbyBrand.action?brand='五菱'" class="logo_name"> <img src="carImage/商标/五菱.jpg" width="70px" height="60px" /><h5>五菱汽车</h5></a>
     <a href="carAction!selectbyBrand.action?brand='红旗'" class="logo_name"> <img src="carImage/商标/红旗.jpg" width="70px" height="60px" /><h5>红旗汽车</h5></a>
     <a href="carAction!selectbyBrand.action?brand='九龙'" class="logo_name"> <img src="carImage/商标/九龙.jpg" width="70px" height="60px" /><h5>九龙汽车</h5></a>
     <a href="carAction!selectbyBrand.action?brand='长安'" class="logo_name"> <img src="carImage/商标/长安.jpg" width="70px" height="60px" /><h5>长安汽车</h5></a>
     <a href="carAction!selectbyBrand.action?brand='奇瑞'" class="logo_name"> <img src="carImage/商标/奇瑞.jpg" width="70px" height="60px" /><h5>奇瑞汽车</h5></a>
    </dd>
   </dl>
   <dl class="mb15">
    <dt>进口车</dt>
    <dd class="marginsx20 clearfix">
     <a href="carAction!selectbyBrand.action?brand='本田'" class="logo_name"> <img src="carImage/商标/本田.jpg" width="70px" height="60px"/><h5>本田汽车</h5></a>
     <a href="carAction!selectbyBrand.action?brand='铃木'" class="logo_name"> <img src="carImage/商标/铃木.jpg" width="70px" height="60px" /><h5>铃木汽车</h5></a>
   	 <a href="carAction!selectbyBrand.action?brand='奥迪'" class="logo_name"> <img src="carImage/商标/奥迪.jpg" width="70px" height="60px" /><h5>奥迪汽车</h5></a>
   	 <a href="carAction!selectbyBrand.action?brand='法拉利'" class="logo_name"> <img src="carImage/商标/法拉利.jpg" width="70px" height="60px" /><h5>法拉利汽车</h5></a>
   	 <a href="carAction!selectbyBrand.action?brand='奔驰'" class="logo_name"> <img src="carImage/商标/奔驰.jpg" width="70px" height="60px" /><h5>奔驰汽车</h5></a>
   	 <a href="carAction!selectbyBrand.action?brand='劳斯莱斯'" class="logo_name"> <img src="carImage/商标/劳斯莱斯.jpg" width="70px" height="60px" /><h5>劳斯莱斯汽车</h5></a>
   	 <a href="carAction!selectbyBrand.action?brand='福特'" class="logo_name"> <img src="carImage/商标/福特.jpg" width="70px" height="60px" /><h5>福特汽车</h5></a>
   	 <a href="carAction!selectbyBrand.action?brand='宝马'" class="logo_name"> <img src="carImage/商标/宝马.jpg" width="70px" height="60px" /><h5>宝马汽车</h5></a>
...
<!--    <dl class="mb15">
    <dt>C</dt>
    <dd class="marginsx20 clearfix">
     <a href="#" class="logo_name"> <img src="images/logo/icon_logo_01.png" /><h5>长安汽车</h5></a>
     <a href="#" class="logo_name"> <img src="images/logo/icon_logo_02.png" /><h5>长安汽车</h5></a>
     <a href="#" class="logo_name"> <img src="images/logo/icon_logo_03.png" /><h5>长安汽车</h5></a>
     <a href="#" class="logo_name"> <img src="images/logo/icon_logo_04.png" /><h5>长安汽车</h5></a>
     <a href="#" class="logo_name"> <img src="images/logo/icon_logo_05.png" /><h5>长安汽车</h5></a>
    </dd>
   </dl> -->
  </div>
  </div>
  ...
  <%--        <ul>
   <li class="gl-item Brand_car_list">
	<div class="Borders">
	 ...
	 <div class="img"><a href=""><img src="images/products/2.jpg" style="width:220px;height:165px"></a></div>
	 <div class="Price"><em>￥</em><b>32.29万</b><span>40.34万</span></div>
	 <div class="name"><a href="产品详细.html" title="【汽车销售自营】Mustang（野马）2016款 2.3T美规自动挡标配">【车商城自营】Mustang（野马）2016款 2.3T美规自动挡标配</a></div>
     <div class="carbox-tip" title="车商城自营现车，可提供3年或10万公里整车质保，4S店支持维修保养，订金：4999元。">车商城自营现车，可提供3年或10万公里整车质保，4S店支持维修保养，订金：4999元。</div>
	...
	<div class="Borders">
	 ...
	 <div class="Price"><em>￥</em><b>32.29万</b><span>40.34万</span></div>
	 <div class="name"><a href="#" title="【汽车销售自营】Mustang（野马）2016款 2.3T美规自动挡标配">【车商城自营】Mustang（野马）2016款 2.3T美规自动挡标配</a></div>
     <div class="carbox-tip" title="车商城自营现车，可提供3年或10万公里整车质保，4S店支持维修保养，订金：4999元。">车商城自营现车，可提供3年或10万公里整车质保，4S店支持维修保养，订金：4999元。</div>
	 <div class="Review">已有<a href="#">2345</a>购买记录</div>	
	 </div>
	</li>
