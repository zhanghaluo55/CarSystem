...
<!--用户中心-用户信息-->
  ...
  <div class="page clearfix">
    ...
    <div class="menu_style">
     ...
     <dl class="accountSideOption1">
      <dt class="transaction_manage on"><a href="用户中心_订单管理.html"><em class="icon_jiantou"></em>保险订单</a></dt>
      <dd >
        <ul>
          <li> <a href="用户中心_订单管理.html">待支付（0）</a></li>
          <li> <a href="用户中心_订单管理.html">已支付（0）</a></li>
          <li> <a href="用户中心_订单管理.html">询价订单（0）</a></li>
  ...
  <!--右侧样式-->
    <div class="right_style Plate_info ">  
      <div class="title_name">密码管理</div>
      <div class="password_style Reg_log_style ">
      <form class="write_login" action="userAction!updatePassword.action">
        <ul class="password_change">
        <li class="frame_style  form_error"><label class="password_icon"></label><input name="oldpassword" type="password" id="yuan_password"><i>原密码</i></li>
         <li class="frame_style  form_error"><label class="password_icon"></label><input name="user.password" type="password" id="tbPassword"><i>输入新密码</i></li>
         <li class="Password_qd">
          ...
          <li class="frame_style form_error"><label class="password_icon"></label><input name="repasswprd" type="password" id="userpwd"><i>确认密码</i></li>
        </ul>
        <button type="submit" class="width-35  btn btn-sm btn-primary" id="btn_password" onclick="">修改密码</button>
        </form>
      </div>
    </div>
   </div> 
