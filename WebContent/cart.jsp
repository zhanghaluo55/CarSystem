...
<div class="page clearfix"> 
 ...
 <!--该样不需要    <div class="cart-table-th">
      <div class="wp">
       <div class="th th-chk">
         <div id="J_SelectAll1" class="select-all J_SelectAll">
          <div class="cart-checkbox">
         <label class="inline"><input type="checkbox" class="ace"><span class="lbl">全选</span></label></div>
          </div>
          </div>
          <div class="th th-item"><div class="td-inner">信息</div></div>
          <div class="th th-price"><div class="td-inner">询价内容</div></div>
          <div class="th th-amount"><div class="td-inner">状态</div></div>
          <div class="th th-sum"><div class="td-inner">报价结果</div></div>
          <div class="th th-op"><div class="td-inner">操作</div></div>
          </div>
         </div>
        
         <div class="xj_OrderList">
         <table cellpadding="0" cellspacing="0" class="Inquiry_order">
         <tbody>
        <tr class="order_number">
         <td colspan="6"><span class="Numbering">订单号：</span><b>WE123456789098</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="time">询价时间：2017-2-12 11:12</span></td>
        </tr>
         <tr class="Inquiry_order_content">
         <td width="80px"><label class="inline"><input type="checkbox" class="ace"><span class="lbl"></span></label></div></td>
         <td width="400px">
          <h4>苏A AS123</h4>
          <h5>车主：张霞</h5>
         </td>
         <td width="200px">交强险/商业险</td>
         <td width="250px">待报价</td>
         <td width="100px">暂无</td>
         <td width="150px">
          <a href="确认保单详细.html" class="btn detailed_btn mb15">查看详细</a>
          <a href="#" class="btn Inquiry_btn">删除</a>
         </td>
        </tr>
       </tbody>
               <tbody>
        <tr class="order_number">
         ...
         <div class="car_operating">
         <label class="inline"><input type="checkbox" class="ace"><span class="lbl">全选</span></label> &nbsp;&nbsp;&nbsp;<a href="javascript:" class="delete">删除所有</a></div>
         </div>
    </ul>-->
<!--     <ul class="cartBox">
        <div class="empty_style">
      ...
      <div class="wp">
       <div class="th th-chk">
         ...
         <label class="inline"><input type="checkbox" class="ace"><span class="lbl">全选</span></label></div>
          ...
          <div class="th th-xinxi"><div class="td-inner">车辆信息</div></div>
          <div class="th th-price"><div class="td-inner">保险公司</div></div>
          <div class="th th-amount"><div class="td-inner">保险内容</div></div>
          <div class="th th-sum"><div class="td-inner">保险价格</div></div>
          <div class="th th-status"><div class="td-inner">状态</div></div>
          <div class="th th-op"><div class="td-inner">操作</div></div>
          </div>
         </div>
         询价订单
         ...
         <tbody>
        <tr class="order_number">
         <td colspan="7"><span class="Numbering">订单号：</span><b>WE123456789098</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="time">询价时间：2017-2-12 11:12</span></td>
        </tr>
         <tr class="Inquiry_order_content">
         <td width="80px"><label class="inline"><input type="checkbox" class="ace"><span class="lbl"></span></label></div></td>
         <td width="250px">
         ...
         <td width="200px">太平洋保险</td>
         <td width="250px">商业险/交强险</td>
         <td width="100px"><b class="bx_price">￥3456/年</b></td>
         <td width="150px">待完善资料</td>
         <td width="150px">
         <a href="javascript:"  onclick="member_del(this,'1')" class="btn  Inquiry_btn mb15">删除订单</a>
          <a href="确认保单详细.html" class="btn detailed_btn mb15">查看详细</a>
          <a href="保单认证.html" class="btn  btn_red">完善资料</a>
         </td>
        </tr>
       </tbody>
               <tbody>
        <tr class="order_number">
         ...
         <td width="200px">平安银行</td>
         <td width="250px">商业险/交强险</td>
         <td width="150px"><b class="bx_price">￥2340/年</b></td>
         <td width="100px">待支付</td>
         <td width="150px">
          <a href="javascript:"  onclick="member_del(this,'2')" class="btn  Inquiry_btn mb15">删除订单</a>
          <a href="确认保单详细.html" class="btn detailed_btn mb15">查看详细</a>
          <a href="保单确认.html" class="btn  btn_red">立即支付</a>
         </td>
        </tr>
       </tbody>
         </table>
         <div class="car_operating clearfix">
         <div class="select-all"><label class="inline"><input type="checkbox" class="ace"><span class="lbl">全选</span></label> &nbsp;&nbsp;&nbsp;<a href="javascript:" class="delete">删除所有</a></div>
         <div class="Payment_operation"><span class="Total_price">总价：<b>5345</b>元</span><a href="保单确认.html" class="btn Payment_operation_btn">立即支付</a></div>
         </div>
         </div>
    </ul> -->
    <ul class="cartBox">
  ...
  <ul class="clearfix">
    ...
    <li class="step_name">选择汽车添加到购物车</li>
    <li class="step_number">2</li>
    <li class="step_name">确认信息，选择支付方式</li>
    <li class="step_number">3</li>
    <li class="step_name">到店支付尾款提车</li>
  </ul>
  </div>
  <div class="Shopping_list">
  <div class="title_name">
    <ul class="clearfix">
	<li class="checkbox">  <label class="inline"><input type="checkbox" class="ace"><span class="lbl"></span></label></li>
 ...
 <table class="table_list" id="table_list">
   ...
   <c:if test="${!empty(cart.carMap)}">
   <c:if test="${cart.username==user1.username}">
   <tbody>
   <c:forEach items="${cart.carMap}" var="me">
   <tr class="tr on" >
   <td class="checkbox"><label class="inline"><input type="checkbox" class="ace"><span class="lbl"></span></label> </td>
    <td class="name">
	  <div class="img"><a href="#"><img src="carImage/${me.value.car.picturePath}1.jpg"></a></div>
	  <div class="p_name"><a href="#">${me.value.car.cname}</a></div>
	</td>
	<td class="scj sp">${me.value.car.price}￥万</td>
	<td class="bgj sp"><fmt:formatNumber type="number" value="${me.value.price*0.01*10000}" pattern="0.00" maxFractionDigits="2" />￥</td>
	<td class="sl">
	    <div class="Numbers">
<%-- 	    href="goodsAction!delCart.action?id=${me.value.car.cid}" 
	    href="goodsAction!addCart.action?id=${me.value.car.cid}"  --%>
		  <a id="jian" class="jian" onclick="jian('${me.value.car.cid}','${me.value.quantity}')">-</a>
		  <input id="number" name="number" type="text" value="${me.value.quantity}" class="number_text">
		  <a id="jia" class="jia" onclick="jia('${me.value.car.cid}')">+</a>
		 </div>
	</td>
	<td class="xj">￥
	<fmt:formatNumber type="number" value="${me.value.price*0.01*10000}" pattern="0.00" maxFractionDigits="2" />
	</td>
	<td class="cz">
    <a href="goodsAction!removeCart.action?id=${me.value.car.cid}" class="btn  btn_huise mb15">删除</a>    
     <a href="carAction!carIntro.action?car.cid=${me.value.car.cid}" class="btn btn_bule mb15">查看详细</a>
     <a href="carAction!cartbuy.action?id=${me.value.car.cid}" class="btn  btn_red ">支付</a>
	</td>
   </tr>
   </c:forEach>
 </tbody>
 ...
 <div class="sp_Operation">
  ...
  <div class="cart-checkbox"><label class="inline"><input type="checkbox" class="ace"><span class="lbl">全选</span></label></div><div class="operation"><a href="#">删除选中的商品</a></div> 
    </div>
   <c:set var="acount" value="0"/>
		<c:forEach items="${cart.carMap}" var="me" >  
  		 <c:set var="acount" value="${acount+me.value.price*0.01*10000}"/>	
   </c:forEach>
	 <!--结算-->
	<div class="toolbar_right">
    <div class="p_Total">
	  <span class="text">总价：</span><span class="price sumPrice"><b>
      <fmt:formatNumber type="number" value="${acount}" pattern="0.00" maxFractionDigits="2" />元</b></span>
	</div>
	
	<div class="btn_style clearfix">
	 <br><br><br><br><br><br>
	 <a class="cartsubmit btn" href="carAction!pagelist.action?page=1">继续购买</a>
	 <a class="continueFind btn" href="carAction!buyAny.action">提交购买</a>
	</div>
  </div>
  </div>
 </div>
 ...
 <li>
	<div class="pic"><a href=""><img src="images/products/3.jpg"></a></div>	
	<div class="title"><a href="#">广汽传祺 传祺GS4 2017款 235T 自动两驱豪华智联版</a></div>
   <div class="p_Price">￥32.50</div>		
  </li>
  <li>
	<div class="pic"><a href=""><img src="images/products/4.jpg"></a></div>	
	<div class="title"><a href="#">广汽传祺 传祺GS4 2017款 235T 自动两驱豪华智联版</a></div>
   <div class="p_Price">￥32.50</div>		
  </li>
  <li>
	<div class="pic"><a href=""><img src="images/products/5.jpg"></a></div>	
	<div class="title"><a href="#">广汽传祺 传祺GS4 2017款 235T 自动两驱豪华智联版</a></div>
   <div class="p_Price">￥32.50</div>		
  </li>
  <li>
	<div class="pic"><a href=""><img src="images/products/6.jpg"></a></div>	
	<div class="title"><a href="#">广汽传祺 传祺GS4 2017款 235T 自动两驱豪华智联版</a></div>
   <div class="p_Price">￥32.50</div>		
  </li>
    <li>
	<div class="pic"><a href=""><img src="images/products/7.jpg"></a></div>	
	<div class="title"><a href="#">广汽传祺 传祺GS4 2017款 235T 自动两驱豪华智联版</a></div>
   <div class="p_Price">￥32.50</div>		
  </li>
  ...
  <script>jQuery("#shopping_cart").slide({trigger:"click",delayTime:0});</script>
</div>
</div>
<!--优势-->
...
<div class="footer">
 <div class="footerbox clearfix" >
  ...
  <div class="weixin_style">
   <div class="sys_style"><img src="小组联系人微信号.png.png"  width="100px"/><h5>小组联系微信</h5></div>
  </div> 
...
function jian(x,y){
	if(y=="1"){
		...
		location.href= href="goodsAction!delCart.action?id="+x;
	}
}
function jia(x){
	location.href= href="goodsAction!addCart.action?id="+x;
}
function submit_btn(){
