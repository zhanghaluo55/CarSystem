...
<!--幻灯片-->
  <div id="slideBox" class="slideBox">
			...
			<div class="bd">
				<ul>
					<li ><a href="#" target="_blank"><div style="background:url(images/主页1.jpg) no-repeat; background-position:center; width:100%; height:450px"></div></a></li>
					<li ><a href="#" target="_blank"><div style="background: url(images/主页2.jpg) no-repeat #FFEDAF; background-position:center; width:100%; height:450px;"></div></a></li>
					<li><a href="#" target="_blank"><div style="background:url(images/主页3.jpg) no-repeat; background-position:center; width:100%; height:450px;"></div></a></li>
				</ul>
			</div>
		 ...
		 <div class="cat_pannel clearfix">
		    <div class="categories-pane">
				<dl class="categories-title">
					...
					<dd>
						<a href="carAction!selectbyBrand.action?brand='奥迪'" class="categories-tag" rel="nofollow" target="_blank" title="汽车保险-大众" data-tab="tab-type-0-out-6"><img src="carImage/商标/奥迪.jpg" height="40" width="50"/>奥迪</a>
						<a href="carAction!selectbyBrand.action?brand='宝马'" class="categories-tag" rel="nofollow" target="_blank" title="汽车保险-长城哈弗" data-tab="tab-type-1-out-6"><img src="carImage/商标/宝马.jpg" height="40" width="50"/>宝马</a>
						<a href="carAction!selectbyBrand.action?brand='奔驰'" class="categories-tag" rel="nofollow" target="_blank" title="汽车保险-宝马" data-tab="tab-type-2-out-6"><img src="carImage/商标/奔驰.jpg" height="40" width="50"/>奔驰</a>
                        <a href="carAction!selectbyBrand.action?brand='本田'" class="categories-tag" rel="nofollow" target="_blank" title="汽车保险-福特" data-tab="tab-type-2-out-6"><img src="carImage/商标/本田.jpg" height="40" width="50"/>本田</a>
                        <a href="carAction!selectbyBrand.action?brand='比亚迪'" class="categories-tag" rel="nofollow" target="_blank" title="汽车保险-奔驰" data-tab="tab-type-2-out-6"><img src="carImage/商标/比亚迪.jpg" height="40" width="50"/>比亚迪</a>
                        <a href="carAction!selectbyBrand.action?brand='法拉利'" class="categories-tag" rel="nofollow" target="_blank" title="汽车保险-上汽" data-tab="tab-type-2-out-6"><img src="carImage/商标/法拉利.jpg" height="40" width="50"/>法拉利</a>
                        <a href="carAction!selectbyBrand.action?brand='福特'" class="categories-tag" rel="nofollow" target="_blank" title="汽车保险-丰田" data-tab="tab-type-2-out-6"><img src="carImage/商标/福特.jpg" height="40" width="50"/>福特</a>
                        <a href="carAction!selectbyBrand.action?brand='九龙'" class="categories-tag" rel="nofollow" target="_blank" title="汽车保险-铃木" data-tab="tab-type-2-out-6"><img src="carImage/商标/九龙.jpg" height="40" width="50"/>九龙</a>
                         <a href="carAction!selectbyBrand.action?brand='铃木'" class="categories-tag" rel="nofollow" target="_blank" title="汽车保险-铃木" data-tab="tab-type-2-out-7"><img src="carImage/商标/铃木.jpg" height="40" width="50"/>铃木</a>
                          <a href="carAction!selectbyBrand.action?brand='长安'" class="categories-tag" rel="nofollow" target="_blank" title="汽车保险-铃木" data-tab="tab-type-2-out-8"><img src="carImage/商标/长安.jpg" height="40" width="50"/>长安</a>
                        <a href="brand.jsp" class="All_brands">所有品牌</a>
					</dd>
                ...
                <div class="f14 mt10">
                    ...
                    <ul class="clearfix hot-tag-list" style="margin-right: -5px;">
                            <li class="fl mr15 mt5"><a href="carAction!selectbyBrand.action?brand='长安'" target="_blank">长安汽车</a></li>                        
                            <li class="fl mr15 mt5"><a href="brand.jsp" target="_blank">国产品牌</a></li>                        
                            <li class="fl mr15 mt5"><a href="carAction!orderbysb.action?sb=cid" target="_blank">最新车款</a></li>                      
                            <li class="fl mr15 mt5"><a href="" target="_blank">驰名品牌</a></li>
                    </ul>
                </div>
				<div class="recommend-product">
                    <a href="car_list.jsp"  class="block" target="_blank" rel="nofollow" title="汽车保险" ><img src="images/adx_11.png" width="100%" alt=""></a>
				</div>
			</div>
		  </div>
		</div>		 
...
<div class="fixedBox">
  <ul class="fixedBoxList">
    <li class="fixeBoxLi cart_bd" style="display:block;" >
	  ...
	  <span class="fixeBoxSpan"></span><a href="cart.jsp"> <strong>购物车</strong></a></li>
