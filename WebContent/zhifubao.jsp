	...
	<div id="main">
		...
		<form name=alipayment action=alipay.trade.page.pay.jsp method=post
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>订单名称 ：</dt>
					<dd>
					<input id="WIDsubject" name="WIDsubject" value="汽车订单"/> 
					</dd>
					<hr class="one_line">
		...
		<s:iterator  var="I" value="#request.session.orderlist">  
    	 <s:set var="total_LASTNUM" value="#total_LASTNUM+price*10000*0.01" ></s:set> 
					...
					<dt>付款金额 ：</dt>
					<dd>
						 <input id="WIDtotal_amount" name="WIDtotal_amount" value="<fmt:formatNumber type="number" value="${total_LASTNUM}" pattern="0.00" maxFractionDigits="2" />"/> 
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
