...
<div class="order_info">
 ...
 <div class="product_List clearfix">
  <table>
       <thead><tr class="title"><td class="name">商品名称</td><td class="price">商品价格</td><td class="Preferential">定金</td><td class="Quantity">购买数量</td><td class="Money">金额</td></tr></thead>
       <tbody>
 		<c:forEach items="${orderlist}" var="orderlist">
       <tr>
        <td class="Product_info">
         <a href="#" class="car_img"><img src="carImage/${orderlist.car.picturePath}1.jpg" width="100px" height="100px"></a>
         <span class="product_style"> <a href="carAction!carIntro.action?user.cid=${orderlist.car.cid}" class="p_name">${orderlist.car.cname}</a><p>颜色：蓝色</p></span>
         
         </td>
        <td><i>￥${orderlist.car.price}</i>万</td>
        <td><i>￥</i><fmt:formatNumber type="number" value="${orderlist.car.price*0.01*10000}" pattern="0.00" maxFractionDigits="2" /></td>
        <td>${orderlist.qunatity}</td>
        <td class="Moneys"><i>￥</i><fmt:formatNumber type="number" value="${orderlist.price*0.01*10000}" pattern="0.00" maxFractionDigits="2" /></td>
       </tr>
       </c:forEach>
        <%-- <tr>
        <td class="Product_info">
           <a href="#" class="car_img"><img src="images/products/5.jpg" width="100px" height="100px"></a>
         <span class="product_style"> <a href="产品详细.html" class="p_name">广汽传祺 传祺GS4 2017款 235T 自动两驱豪华智联版</a><p>颜色：蓝色</p></span>
         </td>
        <td><i>￥</i>13.00万</td>
        <td><i>￥</i>999</td>
        <td>2</td>
        <td class="Moneys"><i>￥</i>999.00</td>
       </tr> --%>
       </tbody>
      </table>
 </div>
 <div class="lump_sum">支付金额：<i>￥</i><b>
        <s:set var="total_LASTNUM" value="0"></s:set>
		<s:iterator  var="I" value="#request.session.orderlist">  
    	 <s:set var="total_LASTNUM" value="#total_LASTNUM+price*10000*0.01" ></s:set> 
        </s:iterator>
 </b><fmt:formatNumber type="number" value="${total_LASTNUM}" pattern="0.00" maxFractionDigits="2" />元</div>
</div>
<!--支付方式-->
<Div class="payment_method">
<div class="title_name">支付方式</div>
<div class="Payment_tips">请使用支付宝支付(下载沙盒支付宝)</div>
<div class=" margin clearfix">
 <a href="zhifubao.jsp" class="Payment_operation"><img src="images/zhifubao.jpg" /></a>
<!--  <a href="#" class="Payment_operation"><img src="images/yinlianzf.jpg" /></a>
 <a href="#" class="Payment_operation"><img src="images/weixinzhif.jpg" /></a> -->
</div>
</Div>
