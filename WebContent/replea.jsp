  ...
  <div class="page clearfix">
    ...
    <div class="menu_style">
     ...
     <div class="user_portrait">
      ...
      <div class="user_name">
       <p><span class="name">${user1.uname}</span><a href="user_password">[修改密码]</a></p>
...
<!--     </dl>       <dl class="accountSideOption1">
  ...
  <div class="title_name">退款操作</div>
   <div class="Refund_operation padding15">
    <div class="Order_Description">
     <h3>订单退款说明：</h3>
     <p>1.以提交购车订单但未支付的无需填写理由直接提交申请，不收取任何费用。</p>
     <p>2.以提交购车订单并支付定金，订单已生效的退款需收取一定比例的违约金。</p>
     <p>3.已成功购买，但因某种原因退款，本商城暂不支持此退款操作。</p>
    </div>
     <div class="label clearfix">
      <span class="label_name">订单状态：</span><span class="content"> ${session.order.flag}</span>
     </div>
      <div class="label clearfix">
       <span class="label_name">退款说明：</span><span class="content"><textarea name="内容" cols="" rows="" class="Opinion_content" id="Refunds_textarea" placeholder="填写内容"></textarea> </span>
     </div>
     <div style="margin-left:100px;"><a href="javascript:" class="btn btn_bule radius" onclick="submit_application(${session.order.oid})">提交申请</a></div>
     <div>      
     </div>
   </div>
  </div>
...
<script>
function submit_application(x){
	$("textarea").each(function() {
		 
		if($(this).val()==""){
		    layer.alert("退款说明不能为空！",{
                title: '提示框',				
				icon:0,								
          }); 		  
		}		
			 ...
			 layer.alert("你申请的退款已提交，请耐心等待客服回复！",{
                title: '提示框',				
				icon:1,		 
          }); 	
			 location.href="orderAction!orderRep.action?oid="+x;
		}		 
	 });	
}
function submit_btn(){
